...
export class CacheService {
  ...
  constructor() {
    ...
    if (!this.redis && env.NODE_ENV === 'production') {
   ...
   */
  async warmup<T>(entries: Array<{ key: string; fetcher: () => Promise<T>; options?: CacheOptions }>): Promise<void> {
  ...
  private setToLocal<T>(key: string, value: T, ttlSeconds: number): void {
