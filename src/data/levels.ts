...
export interface Level {
  level: number;
  title: string;
  xpRequired: number; // XP total necessário desde o nível 1
  xpToNext: number; // XP necessário para próximo nível
...
export function getTierColor(tier: Level['tier']): string {
  const colors = {
    BRONZE: '#CD7F32',
    SILVER: '#C0C0C0',
    GOLD: '#FFD700',
