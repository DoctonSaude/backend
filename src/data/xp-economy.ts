...
export interface XPAction {
  ...
  multipliers?: {
    streak?: number; // Multiplicador por dia de streak
    combo?: number; // Multiplicador se fizer múltiplas ações seguidas
    perfect?: number; // Multiplicador se fizer com perfeição
  };
}
...
// ==========================================
export const CORE_ACTIONS: XPAction[] = [
  {
    id: 'daily-checkin',
    name: 'Login Diário',
...
// ==========================================
export const CONSISTENCY_ACTIONS: XPAction[] = [
  {
    id: 'streak-7-days',
...
// ==========================================
export const SOCIAL_ACTIONS: XPAction[] = [
  {
    id: 'invite-friend',
...
// ==========================================
export const EXPLORATION_ACTIONS: XPAction[] = [
  {
...
// ==========================================
export const MASTERY_ACTIONS: XPAction[] = [
  {
...
// CATÁLOGO UNIFICADO
// ==========================================
export const ALL_XP_ACTIONS: XPAction[] = [
  ...CORE_ACTIONS,
  ...CONSISTENCY_ACTIONS,
  ...SOCIAL_ACTIONS,
  ...EXPLORATION_ACTIONS,
 ...
 */
export const XP_ACTIONS_BY_ID: Record<string, XPAction> = ALL_XP_ACTIONS.reduce(
  (acc, action) => {
...
export function calculateXP(
  ...
  context?: {
    ...
    isPerfect?: boolean;
    isCombo?: boolean;
    duration?: number; // Para ações baseadas em tempo (minutos)
  }
): number {
 ...
 */
export const ESTIMATED_XP_PER_PERIOD = {
