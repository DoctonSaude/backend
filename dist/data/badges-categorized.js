...
exports.RARITY_COLORS = exports.SECRET_BADGES = exports.BADGES_BY_RARITY = exports.BADGES_BY_CATEGORY = exports.BADGES_BY_ID = exports.ALL_BADGES = exports.MASTERY_BADGES = exports.SOCIAL_BADGES = exports.EXPLORATION_BADGES = exports.CONSISTENCY_BADGES = void 0;
// ==========================================
// CATEGORIA: CONSISTENCY (Consistência)
// "O caminho do monge - disciplina diária"
// ==========================================
exports.CONSISTENCY_BADGES = [
    {
        id: 'first-steps',
 ...
 * Índice por ID
 */
exports.BADGES_BY_ID = exports.ALL_BADGES.reduce((acc, badge) => {
    acc[badge.id] = badge;
    return acc;
}, {});
/**
 ...
 */
exports.BADGES_BY_CATEGORY = {
    CONSISTENCY: exports.CONSISTENCY_BADGES,
    EXPLORATION: exports.EXPLORATION_BADGES,
    SOCIAL: exports.SOCIAL_BADGES,
    MASTERY: exports.MASTERY_BADGES
};
/**
 * Badges por raridade
 */
exports.BADGES_BY_RARITY = {
    COMMON: exports.ALL_BADGES.filter(b => b.rarity === 'COMMON'),
    RARE: exports.ALL_BADGES.filter(b => b.rarity === 'RARE'),
    EPIC: exports.ALL_BADGES.filter(b => b.rarity === 'EPIC'),
    LEGENDARY: exports.ALL_BADGES.filter(b => b.rarity === 'LEGENDARY'),
    MYTHIC: exports.ALL_BADGES.filter(b => b.rarity === 'MYTHIC')
};
/**
 * Badges secretos
 */
exports.SECRET_BADGES = exports.ALL_BADGES.filter(b => b.isSecret);
/**
 * Cores por raridade
 */
...
exports.default = exports.ALL_BADGES;
//# sourceMappingURL=badges-categorized.js.map