...
class FinanceService {
     ...
     */
    calculateFees(amount, planTier = 'FREE') {
    ...
    async processAppointmentCompletion(appointmentId) {
        ...
        if (appointment.partner.planTier === 'STARTER' || appointment.partner.planTier === 'BASIC')
            daysToClear = 15;
        if (appointment.partner.planTier === 'PRO')
            daysToClear = 7;
        if (appointment.partner.planTier === 'PREMIUM')
            daysToClear = 1;
