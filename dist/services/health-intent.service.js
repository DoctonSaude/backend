...
exports.healthIntentService = exports.HealthIntentService = void 0;
const prisma_js_1 = __importDefault(require("../lib/prisma.js"));
const engagement_service_js_1 = require("./engagement.service.js");
const health_journey_service_js_1 = require("./health-journey.service.js");
const openai_service_js_1 = __importDefault(require("./ai/openai.service.js"));
class HealthIntentService {
    /**
     * Tenta classificar a intenção via IA (LLM)
     */
    async classifyWithAI(term) {
        ...
        try {
            ...
            const response = await openai_service_js_1.default.createChatCompletion([
    ...
    classifyIntent(term) {
        ...
        if (acuteKeywords.some((k) => lowTerm.includes(k))) {
            return {
        ...
        if (diagKeywords.some((k) => lowTerm.includes(k))) {
            return {
                intent: 'diagnostico',
                confidence: 0.92,
                context: {
        ...
        if (consultKeywords.some((k) => lowTerm.includes(k))) {
            return {
                intent: 'consulta',
                confidence: 0.90,
                context: {
     ...
     */
    async processIntent(patientId, term, eventId) {
        ...
        const intent = await prisma_js_1.default.healthIntent.create({
            data: {
                patientId,
                eventId,
        ...
        if (classification.intent === 'tratamento_agudo') {
            await health_journey_service_js_1.healthJourneyService.startAcuteJourney(patientId, term);
...
exports.HealthIntentService = HealthIntentService;
exports.healthIntentService = new HealthIntentService();
//# sourceMappingURL=health-intent.service.js.map