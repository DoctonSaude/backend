...
exports.PatientReportService = void 0;
...
class PatientReportService {
    ...
    static async generateMedicalRecordPDF(patientId) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const allergiesArr = Array.isArray(patient.allergies) ? patient.allergies : [];
            ...
            for (let i = 0; i < pages.count; i++) {
                doc.switchToPage(i);
                doc.fontSize(8).fillColor('#94a3b8').text(`Página ${i + 1} de ${pages.count} | Documento assinado digitalmente | Docton Saúde`, 50, 780, { align: 'center', width: 495 });
            }
            doc.end();
        });
    }
    static sectionHeader(doc, title) {
...
exports.PatientReportService = PatientReportService;
//# sourceMappingURL=patient-report.service.js.map