...
const nps_feedback_service_js_1 = require("../services/nps-feedback.service.js");
const router = (0, express_1.Router)();
const npsService = new nps_feedback_service_js_1.NPSFeedbackService();
...
router.post('/roadmap/create-items', async (req, res) => {
    try {
        ...
        await npsService.createRoadmapItems(mockReport);
        res.json({
            success: true,
            data: {
...
//# sourceMappingURL=nps-feedback.js.map