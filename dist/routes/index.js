...
const growth_routes_js_1 = __importDefault(require("./growth.routes.js"));
const profile_routes_js_1 = __importDefault(require("./partner/profile.routes.js"));
const finance_routes_js_1 = __importDefault(require("./partner/finance.routes.js"));
const management_routes_js_1 = __importDefault(require("./partner/management.routes.js"));
// import chatRoutes from './chat.routes.js';
const router = (0, express_1.Router)();
console.log('[API] Registrando rotas de Timeline (Prioridade Máxima)...');
// 1. API Core Routes
router.use('/timeline', timeline_routes_js_1.default);
router.use('/patients/timeline', timeline_routes_js_1.default);
router.use('/auth', auth_routes_js_1.default);
router.use('/growth', growth_routes_js_1.default);
router.use('/patients', patient_routes_js_1.default);
// Modular Partner Routes (Fase 6)
router.use('/partners', profile_routes_js_1.default);
router.use('/partners', finance_routes_js_1.default);
router.use('/partners', management_routes_js_1.default);
router.use('/partners', partner_routes_js_1.default); // Fallback legado para as outras 2.500 linhas
// 2. Admin & Management
...
router.use('/growth', growth_routes_js_1.default); // NOVO: Impulso de Crescimento
