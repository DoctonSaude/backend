...
exports.dbErrorHandlerMiddleware = dbErrorHandlerMiddleware;
 ...
 */
function dbErrorHandlerMiddleware(err, req, res, next) {
    ...
    if (isDbError && process.env.NODE_ENV === 'production') {
        logger_js_1.logger.error('[DB Error Handler] Database error intercepted, converting to safe response', {
            error: msg,
            code,
            path: req.path,
            method: req.method,
...
//# sourceMappingURL=db-error-handler.middleware.js.map