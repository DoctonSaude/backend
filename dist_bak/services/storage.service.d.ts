export declare class StorageService {
    ...
    private static readonly BUCKET_MARKETING;
    /**
     ...
     */
    uploadFile(fileBody: Buffer, fileName: string, contentType: string, folder?: string, specificBucket?: string): Promise<string>;
    /**
