...
exports.app.get('/api/nuclear-test-final', (req, res) => {
    res.send('YES-BOSS-ACTIVE');
});
exports.app.get('/api/ping', (req, res) => {
    res.status(200).json({
        status: 'ok',
...
exports.app.use('/api/pharmacy', pharmacy_routes_js_1.default);
// 4. i18n Middleware
...
exports.app.use('/partners', index_js_1.default);
exports.app.use('/partner', index_js_1.default);
exports.app.get('/api/health', async (_req, res) => {
    ...
    const redisHealth = await (0, redis_js_1.checkRedisHealth)();
    res.json({
        status: 'ok',
        db: dbStatus,
        ...
        build_id: "v9-gamification-coins"
    });
});
// --- Diagnóstico Global ---
exports.app.use((req, res, next) => {
...
const startServer = () => {
    ...
    server = httpServer.listen(PORT, '0.0.0.0', () => {
        ...
        if (env_js_1.env.ENABLE_CRON_JOBS && false) { // Forced disable for testing
