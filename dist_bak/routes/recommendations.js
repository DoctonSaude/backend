...
const recommendation_engine_service_js_1 = __importDefault(require("../services/recommendation-engine.service.js"));
const router = (0, express_1.Router)();
const recommendationService = new recommendation_engine_service_js_1.default();
/**
...
router.get('/:userId', async (req, res) => {
    try {
        ...
        const recommendations = await recommendationService.generateRecommendations(userId, context, parseInt(limit) || 10);
        res.json({
            success: true,
            data: {
                user_id: userId,
